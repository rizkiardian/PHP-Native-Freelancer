  ...
  <body>
    ...
    <div class="container mt-5" data-aos="fade-up" data-aos-duration="1500">
      <div class="row project-kategori">
        <div class="col">
          ...
          <!-- Navigasi Graphic Design Kategori -->
          <div class="row mt-5 justify-content-center align-items-center">
            <a class="col-md-3 col-sm-6 icon-wrapper" href="view/homepage/graphic_design_req.php">
          ...
          <!-- Navigasi Digital Marketing Kategori -->
            <a href="view/homepage/digital_marketing_req.php" class="col-md-3 col-sm-6 icon-wrapper">
            ...
            <a href="view/homepage/writing_translation_req.php" class="col-md-3 col-sm-6 icon-wrapper">
            ...
            <!-- Navigasi Video & Animation Kategori -->
            <a href="view/homepage/video_animation_req.php" class="col-md-3 col-sm-6 icon-wrapper">
          ...
          <div class="row mt-5 justify-content-center align-items-center">
            ...
            <!-- Navigasi Musik & Audio Kategori -->
            <a href="view/homepage/musik_audio_req.php" class="col-md-3 col-sm-6 icon-wrapper">
          ...
          <!-- Navigasi Programming Kategori -->
            <a href="view/homepage/programming_req.php" class="col-md-3 col-sm-6 icon-wrapper">
          ...
          <!-- Navigasi Bussiness Kategori -->
            <a href="view/homepage/bussiness_req.php" class="col-md-3 col-sm-6 icon-wrapper">
          ...
          <!-- Navigasi Photography Kategori -->
            <a href="view/homepage/photography_req.php" class="col-md-3 col-sm-6 icon-wrapper">
    ...
    <div class="container-fluid" data-aos="fade-up" data-aos-duration="1500">
      <div class="d-flex justify-content-center mt-5">
        <img src="assets/howwework.png" alt="" style="width: 78%; margin-top: 50px" />
      </div>
    </div>
