...
<body>
                ...
                <div class="content-wrapper">
                  <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">Data Freelancer</h4>
                           <!-- <a href="form.php"><button class="btn btn-primary mt-2 mb-2">Create</button></a>  -->
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><?= $row['status'] ?></td>
                                  <td>
                                    <!-- <a href="form_edit.php"><button class="btn btn-success">Edit</button></a> -->
  ...
  <script>
    document.getElementById('delete').addEventListener('click', function() {
      document.getElementById('output').innerHTML = 'Tombol telah diklik!';
    });
  </script>
