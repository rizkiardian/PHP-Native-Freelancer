<?php
  ...
  $query = "SELECT *, penghasilan.status AS 'status_penghasilan' FROM penghasilan INNER JOIN pembayaran ON penghasilan.id_pembayaran = pembayaran.id_pembayaran INNER JOIN umkm ON pembayaran.id_umkm = umkm.id_user";
  $result = mysqli_query($conn, $query);

  if(isset($_POST['transfer'])){
    $id_penghasilan = $_POST['id_penghasilan'];
    $query_transfer = "UPDATE penghasilan SET status = 'lunas' WHERE id_penghasilan = $id_penghasilan";
                ...
                <div class="content-wrapper">
                  <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">Data Gaji Freelancer</h4>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><?= $row['status_penghasilan'] ?></td>
                                  <td><?= $row['tanggal'] ?></td>
                                  <td><?= $row['pemasukan'] ?></td>
                                  <td>
                                    <form action="" method="POST" onsubmit="return confirm('Apakah Anda sudah mentransfer gaji freelance?');">
                                      <input type="hidden" name="id_penghasilan" value="<?= $row['id_penghasilan'] ?>">
                                      <button type="submit" name="transfer" class="btn btn-success m-1">Transfer</button>
                                    </form>
                                  </td>
                                </tr>
                                <?php
