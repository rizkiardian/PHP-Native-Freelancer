                        ...
                        <div class="content-main d-flex flex-row mt-3 px-4 column-gap-4 ">
                            ...
                            <div class="form-ulas d-flex flex-column justify-content-evenly">
                                <div class="judul-project">
                                    <div class="row">
                                        <div class="col-10">
                                            <h6 style="font-size: 24px;">Design 3D Animation Logo for Youtube | 3D Blender</h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <p>
                                                Beri ulasan untuk project yang telah diselesaikan freelancer
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="input-ulasan">
                                    <textarea name="" id="" cols="70" rows="5" class="shadow-sm" placeholder="Tulis ulasan disini..."></textarea>
                                    <div class="button-kirim d-flex justify-content-end column-gap-3">
                                        <button class="cancel-button">Cancel</button>
                                        <button class="kirim-button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Kirim</button>
                                    </div> 
                                </div>   
                            </div>
